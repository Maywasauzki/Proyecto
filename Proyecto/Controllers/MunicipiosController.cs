        ...
        public ActionResult Create(Municipio municipio)
        {
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    TempData["AlertMessage"] = "¡Municipio creado exitosamente ....!";
        ...
        public ActionResult Edit(Municipio municipio)
        {
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    db.SaveChanges();
                    TempData["AlertMessage"] = "¡Municipio modificado exitosamente ....!";
                    return RedirectToAction("Index");
        ...
        public ActionResult Delete(int id)
        {
            ...
            else 
            {
                try
                {
                    ...
                    db.SaveChanges();
                    TempData["AlertMessage"] = "¡Municipio eliminado exitosamente ....!";
