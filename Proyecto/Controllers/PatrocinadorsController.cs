    ...
    public class PatrocinadorsController : Controller
    {
        ...
        public ActionResult Create(Patrocinador patrocinador)
        {
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    db.SaveChanges();
                    TempData["AlertMessage"] = "¡Patrocinador creado exitosamente ....!";
        ...
        public ActionResult Edit(Patrocinador patrocinador)
        {
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    db.SaveChanges();
                    TempData["AlertMessage"] = "¡Patrocinador modificado exitosamente ....!";
                    return RedirectToAction("Index");
        ...
        public ActionResult Delete(int id)
        {
            ...
            else
            {
                ...
                db.SaveChanges();
                TempData["AlertMessage"] = "¡Patrocinador eliminado exitosamente ....!";
            }
            return RedirectToAction("Index");
